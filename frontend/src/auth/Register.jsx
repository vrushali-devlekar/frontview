  ...
  return (
    <div className="h-screen overflow-hidden bg-[#050505] text-[#d1d1d1] font-['Minecraftia',monospace] flex flex-col lg:flex-row">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-[#050505]">
        ...
        {/* Secure Badge */}
        <div className="absolute bottom-12 left-1/2 -translate-x-1/2 bg-[#0a0a0a]/90 backdrop-blur-sm border border-white/5 p-4 pr-12 rounded-2xl flex items-center gap-4 w-fit whitespace-nowrap z-20">
          <div className="text-[#558760]">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.2 6.24-2.72a1.17 1.17 0 0 1 1.52 0C14.51 3.81 17 5 19 5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/></svg>
          </div>
          <div className="flex flex-col text-left">
            <p className="text-[12px] text-gray-200 normal-case tracking-normal">Secure. Encrypted. Reliable.</p>
            <p className="text-[11px] text-gray-500 mt-0.5 normal-case tracking-normal">Built for developers, by developers.</p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-[#0f0f0f] border border-white/5 p-8 md:p-10 shadow-2xl rounded-[24px]">
            <header className="text-center mb-8">
              ...
              <p className="text-gray-400 text-xs">
                Start building with Velora
              </p>
            </header>

            {/* Social Login */}
            <button className="w-full bg-[#e5deb8] hover:bg-[#d4cd9e] text-black py-3 rounded-xl flex items-center justify-center gap-3 font-medium transition-all mb-8">
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="w-full bg-[#4a7051] hover:bg-[#3d5c43] text-white py-3.5 rounded-xl text-sm font-normal transition-all mt-6">
                Create Account
              </button>
            </form>
