            ...
            <div className="flex items-center justify-between mb-12">
              <div>
                ...
                <p className="text-[14px] text-[#71717a]">
                  {step === 1
                    ? "Connect your repository to the Velora Engine"
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  <span
                    className={`w-2.5 h-2.5 rounded-full ${step >= 1 ? "bg-white" : "bg-white/10"}`}
                  />
                  <span
                    className={`w-2.5 h-2.5 rounded-full ${step >= 2 ? "bg-white" : "bg-white/10"}`}
                  />
                </div>
              </div>
            </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                      ...
                      <div className="flex-1 overflow-y-auto p-4 space-y-2 scrollbar-hide">
                        {reposLoading ? (
                          [1, 2, 3, 4, 5].map((i) => (
                            <div
                              key={i}
                              className="h-14 bg-white/[0.02] animate-pulse rounded-2xl"
                            />
                          ))
                        ) : repos.length > 0 ? (
                          repos
                            ...
                            .map((repo) => (
                              ...
                              >
                                <div className="flex items-center gap-3">
                                  ...
                                  <span className="text-[13.5px] font-medium text-white/80 group-hover:text-white">
                                    {repo.name}
                                  </span>
                                </div>
                                <div className="flex items-center gap-3">
                                  ...
                                  <ArrowRight
                                    size={14}
                                    className="text-[#3f3f46] group-hover:text-white transition-all transform group-hover:translate-x-1"
                                  />
                                </div>
                              </button>
                            ))
                          ...
                          <div className="h-full flex flex-col items-center justify-center text-center p-8">
                            ...
                            />
                            <p className="text-[13px] text-[#52525b] max-w-[200px]">
                              No repositories found. Connect your GitHub
                              account.
                            </p>
                          </div>
                        )}
                    ...
                    <div className="lg:col-span-2 space-y-6">
                      <div className="bg-[#111113] border border-white/[0.06] rounded-[32px] p-8 shadow-2xl relative overflow-hidden">
                        ...
                        <p className="text-[13px] text-[#71717a] mb-8 leading-relaxed">
                          Paste a public Git URL to deploy any open-source
                          project instantly.
                        </p>
                      ...
                      <div className="bg-white/[0.02] border border-white/[0.04] rounded-3xl p-6">
                        ...
                        <p className="text-[12px] text-[#52525b] leading-relaxed">
                          Our engine automatically detects framework settings,
                          environment requirements, and build pipelines.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                >
                  ...
                  <div className="lg:col-span-2 space-y-6">
                    <div className="bg-[#111113] border border-white/[0.06] rounded-[32px] p-8 shadow-2xl">
                      <div className="flex items-center justify-between mb-8 pb-6 border-b border-white/[0.06]">
                        ...
                        <button
                          onClick={() => setStep(1)}
                          className="text-[12px] font-bold text-[#71717a] hover:text-white transition-colors"
                        >
                          Change Repo
                        </button>
                      </div>
                      ...
                      <div className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <div className="space-y-2">
                            <label className="text-[11px] font-black text-[#3f3f46] uppercase tracking-[0.2em] ml-1">
                              Framework Preset
                            </label>
                            <div className="relative group">
                              ...
                              <ChevronDown
                                size={14}
                                className="absolute right-5 top-1/2 -translate-y-1/2 text-[#52525b] pointer-events-none group-hover:text-white transition-colors"
                              />
                            </div>
                          </div>
                        </div>
                        ...
                        <div>
                          ...
                          >
                            <Settings2 size={14} /> Build and Output Settings{" "}
                            {showAdvanced ? (
                              <ChevronUp size={12} />
                            ) : (
                              <ChevronDown size={12} />
                        ...
                        <div className="pt-8 border-t border-white/[0.06]">
                          <div className="flex items-center justify-between mb-6">
                            <h4 className="text-[13px] font-bold uppercase tracking-wider text-[#3f3f46]">
                              Environment Variables
                            </h4>
                            <GlassButton
                              variant="secondary"
                        ...
                        {error && (
                          <div className="p-4 bg-red-500/10 border border-red-500/20 rounded-2xl text-red-500 text-[13px] font-medium">
                            {error}
                          </div>
                        )}
                  ...
                  <div className="space-y-6">
                    <div className="bg-white/[0.02] border border-white/[0.06] rounded-[32px] p-8">
                      <h4 className="text-[12px] font-black text-[#3f3f46] uppercase tracking-[0.2em] mb-6">
                        Build Insights
                      </h4>
                      <ul className="space-y-6">
                        <li className="flex gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[12px] text-[#52525b]">
                              Deployments will be automatically triggered on
                              push to{" "}
                              <code className="text-white bg-white/5 px-1 rounded">
                                {branch}
                              </code>
                              .
                            </p>
                        ...
                        <li className="flex gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-[12px] text-[#52525b]">
                              Velora uses ephemeral build workers to ensure your
