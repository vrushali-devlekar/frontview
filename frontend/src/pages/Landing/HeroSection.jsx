      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <nav className="flex items-center justify-between px-6 py-6 md:px-12">
          ...
          <div className="flex items-center gap-4">
            <button className="hidden sm:block text-[10px] uppercase text-gray-400 hover:text-white transition">
              Log In
            </button>
            <button className="bg-[#facc15] text-black px-4 py-2 text-[9px] md:text-[10px] font-bold uppercase shadow-[3px_3px_0px_0px_rgba(255,255,255,0.3)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-none transition-all">
              Start Building
            </button>
          </div>
        </nav>
        ...
        <main className="grow flex flex-col justify-center px-4 md:px-20 lg:px-32">
          <div className="max-w-5xl">
            ...
            <div className="mt-10 flex flex-wrap gap-6">
              <button className="bg-[#facc15] text-black px-5 py-2 text-[8px] md:text-xs font-md uppercase shadow-[5px_5px_0px_0px_rgba(255,255,255,0.4)] hover:scale-105 active:translate-y-1 active:shadow-none transition-all">
                Start Building
              </button>
