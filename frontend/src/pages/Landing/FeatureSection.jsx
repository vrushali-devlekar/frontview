    ...
    <section className="bg-black text-white font-press-start py-20 px-6 md:px-20">
      ...
      <div className="mb-16">
        <h2 className="text-xl md:text-3xl leading-relaxed max-w-2xl uppercase">
          Everything you need to <span className="text-[#facc15]">ship</span>{" "}
          and scale.
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {cards.map((card, index) => (
          <div
            key={index}
            className="bg-[#111111] border border-gray-800 rounded-xl p-8 flex flex-col items-start relative group hover:border-[#facc15] transition-colors"
          >
            <img
              src={card.img}
              alt={card.title}
            ...
            />
            <h3 className="text-sm mb-4 text-white uppercase tracking-tight">
              {card.title}
            </h3>
            <p className="text-[10px] leading-loose text-gray-500 mb-10 uppercase">
              {card.desc}
            </p>
      ...
      <div className="bg-[#111111] border border-gray-800 rounded-xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="w-full md:w-1/2">
          <h3 className="text-sm md:text-base mb-6 uppercase leading-relaxed">
            Deployments that just work.
          </h3>
          <p className="text-[10px] md:text-xs text-gray-500 leading-loose uppercase">
            From commit to production in seconds. Instant rollbacks. Preview
            deployments. Everything optimized for{" "}
