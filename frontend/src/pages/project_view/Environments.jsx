  ...
  const envVars = [
    {
      id: 1,
      key: "DATABASE_URL",
      value: "postgresql://user:pass@db.velora.internal:5432/main",
    },
    ...
    <div className="flex h-screen bg-black text-white font-sans overflow-hidden">
      ...
      <PageWrapper navMode={navMode} isCollapsed={isCollapsed}>
        ...
        <PageShell>
          <PageHeader
            title="Environments"
            subtitle="Manage environment configurations across all projects"
          >
          ...
          >
                    ...
                    {filtered.map((env) => (
                      ...
                      >
                        <td className="px-7 py-5">
                          <div className="flex items-center gap-3">
                            <span className="px-2.5 py-1 rounded-lg text-[10px] font-mono font-semibold bg-white/10 border border-white/20 text-purple-300 uppercase tracking-wider">
                              {env.tag}
                            </span>
                        ...
                        <td className="px-7 py-5 text-[13px] text-purple-200">
                          {env.project}
                        </td>
                        <td className="px-7 py-5">
                          <div className="flex items-center gap-1.5 text-[12px] text-purple-200 font-mono">
                            <GitBranch
                              size={11}
                        ...
                        <td className="px-7 py-5">
                          <div className="flex items-center gap-1.5 text-[13px] text-purple-200">
                            <Key
                              size={11}
                              className="text-purple-300 shrink-0"
                            />{" "}
                        ...
                        <td className="px-7 py-5 text-right">
                          <button className="opacity-0 group-hover:opacity-100 p-1.5 rounded-lg text-purple-300 hover:text-white hover:bg-white/10 transition-all">
            ...
            >
              <CardHeader icon={Shield} title="Secrets Vault">
                ...
                <GlassButton
                  variant="secondary"
                  className="h-8 text-xs px-3 gap-1.5 bg-green-600 backdrop-blur-md border border-green-500 hover:bg-green-700"
                >
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-white/10">
                    {envVars.map((env) => (
                      ...
                      >
                        <td className="px-7 py-5 text-[13px] font-mono text-emerald-400">
                          {env.key}
                        </td>
                        <td className="px-7 py-5 text-[13px] font-mono text-purple-300">
                        ...
                        <td className="px-7 py-5 text-right">
                          <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity justify-end">
                            <button
                              ...
                              className="p-1.5 rounded-lg text-purple-300 hover:text-white hover:bg-white/10 transition-all"
                            >
                              {revealed[env.id] ? (
                                <EyeOff size={13} />
                              ) : (
                            ...
                            <button className="p-1.5 rounded-lg text-purple-300 hover:text-red-400 hover:bg-red-500/20 transition-all">
                              <Trash2 size={13} />
                            </button>
                          </div>
                        </td>
              ...
              <div className="px-7 py-5 border-t border-white/10 flex items-center gap-2.5 bg-white/5">
                <Shield size={12} className="text-emerald-400 shrink-0" />
                <p className="text-[12px] text-purple-200">
                  All values are encrypted at rest. Access is restricted to
          ...
          <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/60 backdrop-blur-sm px-4">
            ...
            >
              ...
              <p className="text-[13px] text-[#71717a] mb-6">
                Initialize a new stage for your project deployments.
              </p>

              <div className="space-y-4">
                <div>
                  <label className="block text-[11px] font-bold text-[#3f3f46] uppercase tracking-widest mb-2">
                    Environment Name
                  </label>
                  <input
                    type="text"
