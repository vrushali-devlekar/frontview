      ...
      >
        ...
        <div className="flex-1 overflow-y-auto py-5">
          <div className="px-3 mb-4">
            ...
            <MenuItem icon={Zap}      label="Deployments"   to="/deployments"      isCollapsed={isCollapsed} />
        ...
        <div className="relative p-4 border-t border-[#2c2c2b]" ref={dropdownRef}>
          ...
          >
            <div className="w-10 h-10 rounded flex items-center justify-center overflow-hidden shrink-0 border border-white/10">
